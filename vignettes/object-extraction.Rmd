...
```{r active_contor_object_profile_image_split_overlay}
...
```{r active_contor_object_profile_contour_mean, fig.show='hold'}
...
```{r active_contor_object_final proof, fig.show='hold'}
